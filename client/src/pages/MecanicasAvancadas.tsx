      ...
      <div className="container max-w-6xl mx-auto px-4 md:px-6 lg:px-8">
              ...
              <Card className="p-8 bl-card bl-card-flow overflow-hidden relative">
                ...
                <div className="relative z-10">
                  <div className="flex flex-col sm:flex-row sm:items-start gap-4 mb-6">
                    <div
                      className="w-14 h-14 sm:w-16 sm:h-16 rounded-sm flex items-center justify-center flex-shrink-0 font-display text-xl sm:text-2xl font-bold"
                      style={{ background: 'oklch(0.52 0.22 260 / 0.2)', color: 'oklch(0.52 0.22 260)' }}
                    >
                      {idx + 1}
                    </div>
                    <div className="flex-1">
                      <h2 className="font-display text-2xl sm:text-3xl text-white mb-2" style={{ color: 'oklch(0.52 0.22 260)' }}>
                        {mecanica.nome}
                      </h2>
                      <p className="text-muted-foreground text-sm sm:text-base">{mecanica.descricao}</p>
                    </div>
                  </div>

                  <div className="grid sm:grid-cols-2 gap-4 md:gap-6">
                    <div className="p-4 rounded-sm" style={{ background: 'oklch(0.52 0.22 260 / 0.1)', border: '1px solid oklch(0.52 0.22 260 / 0.2)' }}>
                      <h3 className="font-heading text-xs sm:text-sm tracking-wider uppercase mb-2" style={{ color: 'oklch(0.52 0.22 260)' }}>Como Funciona</h3>
                      <p className="text-muted-foreground text-xs sm:text-sm leading-relaxed">{mecanica.como}</p>
                    </div>

                    <div className="p-4 rounded-sm" style={{ background: 'oklch(0.52 0.22 260 / 0.1)', border: '1px solid oklch(0.52 0.22 260 / 0.2)' }}>
                      <h3 className="font-heading text-xs sm:text-sm tracking-wider uppercase mb-2" style={{ color: 'oklch(0.52 0.22 260)' }}>Bônus</h3>
                      <p className="text-muted-foreground text-xs sm:text-sm leading-relaxed">{mecanica.bonus}</p>
                    </div>
                  </div>
                </div>
              </Card>
        ...
        >
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6">
            <Card className="p-4 md:p-6 bl-card">
              <h3 className="font-heading text-base md:text-lg font-semibold text-white mb-3 flex items-center gap-2">
        ...
        <motion.section
          ...
          style={{ borderColor: 'oklch(0.22 0.03 260)' }}
        >
          <h2 className="font-display text-3xl md:text-4xl text-white tracking-wider mb-6 md:mb-8">RECOMENDAÇÕES PARA NARRADORES</h2>

          <Card className="p-4 md:p-8 bl-card">
            <div className="space-y-4 md:space-y-6">
              <div className="flex gap-3 md:gap-4">
                <div className="w-1 bg-gradient-to-b flex-shrink-0" style={{ background: 'oklch(0.52 0.22 260)' }}></div>
                <div>
                  <h3 className="font-heading text-white font-semibold mb-2 text-base md:text-lg">Não Combine Todas as Formas</h3>
              ...
              <div className="flex gap-3 md:gap-4">
                <div className="w-1 bg-gradient-to-b flex-shrink-0" style={{ background: 'oklch(0.52 0.22 260)' }}></div>
                <div>
                  <h3 className="font-heading text-white font-semibold mb-2 text-base md:text-lg">Mecânicas Avançadas para Jogadores Experientes</h3>
                  <p className="text-muted-foreground text-xs md:text-sm">
              ...
              <div className="flex gap-3 md:gap-4">
                <div className="w-1 bg-gradient-to-b flex-shrink-0" style={{ background: 'oklch(0.52 0.22 260)' }}></div>
                <div>
                  <h3 className="font-heading text-white font-semibold mb-2 text-base md:text-lg">Valorize a Criatividade</h3>
                  <p className="text-muted-foreground text-xs md:text-sm">
              ...
              <div className="flex gap-3 md:gap-4">
                <div className="w-1 bg-gradient-to-b flex-shrink-0" style={{ background: 'oklch(0.52 0.22 260)' }}></div>
                <div>
                  <h3 className="font-heading text-white font-semibold mb-2 text-base md:text-lg">Restrições de Habilidades</h3>
                  <p className="text-muted-foreground text-xs md:text-sm">
